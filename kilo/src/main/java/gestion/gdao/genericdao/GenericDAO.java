package gestion.gdao.genericdao;

import gestion.gdao.confreader.reader.Reader;
...
public class GenericDAO {
    public static void check(String file) throws IOException {
    ...
    public static Connection getConPost() throws IOException, ClassNotFoundException, SQLException {
        ...
        String tempURL = conf.get("url") + port +"/"+ conf.get("database");
                    ...
                    if (RS.getObject(champSelect.get(i)) != null) {
                        if (cn.fk()) {// if foreign key
                            ...
                            for (Field liFi21 : liFi2) {
                                ...
                                if (cn2 != null && cn2.pk()) {
                                    Method set2 = tempOb.getClass().getMethod("set" + UCFirst(liFi21.getName()),
                                            liFi21.getType()); // set id
                            ...
                            System.out.println(fiSetable.get(i).getType().getName() + " "
                                    + RS.getObject(champSelect.get(i)).getClass().getName());
